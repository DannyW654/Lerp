...
public class SubExp extends BinaryExp {
    ...
    public Triple<ANFVarExp, ANFOp, Expression> extract() {
        if (super.getExp1() instanceof Holder && super.getExp2() instanceof Holder){
            ...
            ANFSubOp a = new ANFSubOp(((Holder) super.getExp1()).getVar(),((Holder)super.getExp2()).getVar());
            ...
            return new Triple(data.first(), data.second(), new SubExp(super.getExp1(), data.third()));
        }
        else{
            Triple<ANFVarExp, ANFOp, Expression> data = super.getExp1().extract();
            return new Triple(data.first(), data.second(), new SubExp(data.third(), super.getExp2()));
        }
    }
